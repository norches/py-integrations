...
class PromoProgram(RegosModel):
    ...
    type: PromoProgramType | None = PydField(default=None)
    active: bool | None = PydField(default=None)
    days: list[int] | None = PydField(default=None)
    start_time: str | None = PydField(default=None)
    end_time: str | None = PydField(default=None)
    start_date: str | None = PydField(default=None)
    end_date: str | None = PydField(default=None)
    description: str | None = PydField(default=None)
    sub_type: int | None = PydField(default=None)
...
class PromoProgramArrayRegosObjectResult(RegosModel):
    ...
    result: list[PromoProgram] | Error | None = PydField(default=None)
...
class PromoProgramGet(RegosModel):
    ...
    allowed_retail_card: bool | None = PydField(default=None)
